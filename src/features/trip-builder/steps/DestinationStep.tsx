      ...
      <div className="w-full max-w-3xl rounded-3xl bg-white/95 backdrop-blur-sm shadow-lg border border-border/50 px-8 sm:px-16 py-16 sm:py-20 flex flex-col items-center">
        ...
        <div className="mt-8 w-full max-w-md">
          <input
            ...
            className="w-full h-10 rounded-full border border-border bg-white px-6 text-sm outline-none placeholder:text-muted/60 focus:border-brand/30 focus:shadow-sm transition-all"
          />
        </div>
